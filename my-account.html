					...
					<div class="sidebar left">
						...
						<div class="my-account-nav-container">
							...
							<ul class="my-account-nav">
								...
								<li><a href="my-account.html" class="current"><i class="ti-user"></i> My Profile</a></li>
								<li><a href="my-earnings.html" class=""><i class="ti-money"></i> Earnings</a></li> 
								<li><a href="my-report.html" class=""><i class="ti-pie-chart"></i> Report</a></li>
								<li><a href="mail.html" class=""><i class="ti-email"></i> Messages</a></li> 
							</ul>
							...
							<div class="edit-profile-photo">
								...
								<div class="change-photo-btn">
									<div class="photoUpload">
										<span><i class="ti-upload"></i> Upload Photo</span>
