			...
			<div class="row">
				<div class="col-md-12">
					<ul class="breadcrumbs list-inline text-left">
						<li><a href="#">Home</a></li>  
						<li><span>Mail / Notifications</span></li>
					</ul>
					<h1>Debo</h1>
				...
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-12 my-profile">
							<h4 class="margin-top-0 margin-bottom-30">Motifications </h4> 
							<div id="accordion">
							  <div class="card">
							  ...
							  <div class="card">
								<div class="card-header" id="headingTwo">
								  <h5 class="mb-0">
									<a href="#" class="" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
