					...
					<div class="sidebar left">
						...
						<div class="my-account-nav-container">
							...
							<ul class="my-account-nav">
								...
								<li><a href="my-earnings.html" class="current"><i class="ti-money"></i> Earnings</a></li> 
							</ul>
					...
					<div class="row">
						...
						<div class="col-md-12 my-profile">
							<div class="notification notice large margin-bottom-55"> 
								<p>Payment Automatically credited in your account, Once reach the amount $XXXXX.</p>
							</div>
							<h4 class="margin-top-0 margin-bottom-30">My Earnings</h4> 
							<table class="table">
							...
							<hr />
							<br />
							<h4 class="margin-top-0 margin-bottom-30">Pending Payout Request</h4> 
							<table class="table">
							  <thead class="bg-light">
								<tr>
								  <th scope="col">#</th>
							...
							<hr />
							<br />
							<h4 class="margin-top-0 margin-bottom-30">Payment Information</h4> 
							<table class="table">
							  <thead class="bg-light">
								<tr>
								  <th scope="col">#</th>
